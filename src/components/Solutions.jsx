        ...
        <div className="solutions-content-container">
          <div className="solutions-content-animation">
            <div className="solutions-content">
              ...
              <ul className="OERP">
                <li>
                  Achieve maximum sales push from existing markets by adding new
                  retail outlets.
                </li>
                <li>
                  Identify white-spaces in existing markets to set up new retail
                  outlets.
                </li>
                <li>
              ...
              <ul className="TMF">
                <li>
                  Monitor daily customer footfall in and around your trade area.
                </li>
                <li>Compare potential locations based on footfall.</li>
                <li>
                  Analyse customer tastes & preferences of visiting audience to
                  your store.
                </li>
              </ul>
              ...
              <ul className="ODN">
                <li>
                  Pick areas/locations to setup new dealerships in your existing
                  markets to push your sales.
                </li>
                <li>
          ...
          <div className="solutions-map">
            ...
            <img
              className="solutions-map-menu"
              src={require("../images/solutions-menu.png")}
              alt=""
            />
          </div>
        </div>
